...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> 
{
    ...
    public boolean registerPacket(Class<? extends AbstractPacket> clazz)
    {
        ...
        {
            System.out.println("Packet already registered");
            return false;
        }
        if (this.isPostInitialised)
        {
            System.out.println("Packet registered too late");
            return false;
        }
    ...
    {
        this.channels = NetworkRegistry.INSTANCE.newChannel(ModLBD.name, this);
    }
