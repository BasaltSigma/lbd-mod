...
public class TileEntityLightDoorSectionRenderer extends TileEntitySpecialRenderer
{
	private ModelLightDoorSection model = new ModelLightDoorSection();
	private byte index;
	
	public void renderAModelAt(TileEntityLightDoorSection par1, double par2, double par3, double par4, float par5)
	{
		int par6 = 0;
	...
	{
		this.renderAModelAt((TileEntityLightDoorSection)par1TileEntity, par2, par3, par4, par5);
	}
}
